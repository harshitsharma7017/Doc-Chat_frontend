          ...
          <div className="w-full">
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <h1 className="text-4xl font-bold text-white mb-2 tracking-tight">{collection.name}</h1>
                <p className="text-gray-400 text-sm max-w-2xl">{collection.description || 'No description provided.'}</p>
              </div>
              <button 
                onClick={() => setIsModalOpen(true)}
                className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 rounded-xl text-sm font-medium text-white transition-colors shadow-lg shadow-indigo-500/20"
              >
                <FolderPlus size={16} />
                Add Documents
              </button>
