      ...
      <div className="flex-1 flex flex-col relative bg-gradient-to-br from-[#0b0c10] via-[#11131a] to-[#0b0c10]">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-10 custom-scrollbar">
          <div className="w-full">
            ...
            {/* Page Header */}
            <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 sm:gap-0 mb-6 md:mb-8">
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight">Collections</h1>
                <p className="text-gray-400 text-sm">Manage and analyze grouped document sets.</p>
              </div>
              <button 
                onClick={() => setIsModalOpen(true)}
                className="flex items-center justify-center gap-2 px-5 py-2.5 bg-[#1a1b23] hover:bg-[#252630] border border-white/5 rounded-xl text-sm font-medium text-gray-200 transition-colors w-full sm:w-auto"
              >
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 md:gap-0 mb-8">
              <div className="flex space-x-1 bg-[#121319] p-1 rounded-xl border border-white/5 overflow-x-auto custom-scrollbar shrink-0">
                {['All', 'Recent', 'Shared'].map(tab => (
                  <button 
                    key={tab}
                    onClick={() => setActiveTab(tab)}
                    className={`px-4 md:px-6 py-1.5 rounded-lg text-sm font-medium transition-all whitespace-nowrap ${
